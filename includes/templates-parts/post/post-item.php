...
echo   get_the_post_thumbnail(get_the_ID(), array( 478, 322), array('class' => 'thinkus-post-image'));
...
echo '<div class="post-wrapper__content__text__content">'.thinkus_custom_excerpts(15). '</div>';
echo '</a>';
echo '</div>';